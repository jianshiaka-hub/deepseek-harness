...
export const zh = {
  ...
  'version.update': '可更新',
  'version.upgrading': '正在更新…',
  'version.upgradeError': '更新失败，请重试。',
...
export const en = {
  ...
  'version.update': 'Update available',
  'version.upgrading': 'Updating…',
  'version.upgradeError': 'Update failed. Please try again.',
