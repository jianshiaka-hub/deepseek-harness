...
it('clears a failed load when the main page retries without a toolbar command', async () => {
  ...
  const bridge: DesktopBrowserBridge = {
    ...
    foreignInputState: vi.fn(async () => { throw new Error('not used in navigation test') }),
    foreignSecondaryState: vi.fn(async () => { throw new Error('not used in navigation test') }),
    dragPoint: vi.fn(async () => { throw new Error('not used in navigation test') }),
    selectForeignOption: vi.fn(async () => { throw new Error('not used in navigation test') }),
    selectForeignText: vi.fn(async () => { throw new Error('not used in navigation test') }),
