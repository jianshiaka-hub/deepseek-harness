...
export const DESKTOP_IPC = {
  ...
  browserDragPoint: 'dsh-desktop:browser-drag-point',
  ...
  browserDragBegin: 'dsh-desktop:browser-drag-begin',
  browserDragEnd: 'dsh-desktop:browser-drag-end',
  browserDialogBegin: 'dsh-desktop:browser-dialog-begin',
  browserNavigate: 'dsh-desktop:browser-navigate',
  browserDialogGet: 'dsh-desktop:browser-dialog-get',
  browserDialogWait: 'dsh-desktop:browser-dialog-wait',
