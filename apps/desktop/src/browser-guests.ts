...
import type { BrowserPageScreenshot, BrowserScreenshotClip, BrowserLocateResult, BrowserForeignRefPoint, BrowserForeignInputState, BrowserForeignOptionResult, DesktopBrowserLeaseId, DesktopBrowserOpenRequest, DesktopBrowserReservation } from '@deepseek-ai/dsh-client-ui-sidebar-browser/types'
